...
TString dir = gSystem->UnixPathName(__FILE__);
   dir.ReplaceAll("hw3_3.cc","");
   dir.ReplaceAll("/./","/");
  // read file and add to fit object
   Double_t *x = new Double_t[500];
   Double_t *y = new Double_t[500];
   Double_t *z = new Double_t[500];
   Double_t *w = new Double_t[500];   

   Double_t vX, vY, vZ,vW,vP;
   Int_t vNData = 0;
   ifstream vInput;
   vInput.open(Form("%srandomWalkFftNoW.dat",dir.Data()));
   while (1) {
   ...
   Double_t *t = new Double_t[500];   

   Double_t *h = new Double_t[500];   
   Double_t vH,vT;
   Int_t vNData2 = 0;
   ifstream vInput2;
   vInput2.open(Form("%srandomWalkFftW.dat",dir.Data()));
   while (1) {
      vInput2 >> vT >> vH;
...
//    graph -> SetTitle("temp");
    graph->DrawClone("APE");
       mg-> Add(graph);
    mg->SetTitle( "Power spectrum of Random walk density before & after CIC window correction ; k ; power ");
